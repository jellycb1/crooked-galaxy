...
func _init() -> void:
	...
	check(Content.PLANETS[28] == AgenciaDeuses.PLANET and Content.TARGETS.slice(112, 116) == AgenciaDeuses.TARGETS and Content.HUNT_EVENTS.slice(56, 58) == AgenciaDeuses.EVENTS, "level-260 pack is composed in canonical order")
	...
	check(Content.PLANETS[30] == OficinaRealidades.PLANET and Content.TARGETS.slice(120, 124) == OficinaRealidades.TARGETS and Content.HUNT_EVENTS.slice(60, 62) == OficinaRealidades.EVENTS, "level-280 pack is composed in canonical order")
