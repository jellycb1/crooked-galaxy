...
func _init() -> void:
	...
	for method_name in ["get_economy", "get_build", "get_hunt_board", "get_agency_membership", "get_agency_directory", "create_agency", "apply_to_agency", "accept_hunt", "resolve_hunt", "claim_reward", "allocate_attributes", "equip_item", "recycle_item"]:
