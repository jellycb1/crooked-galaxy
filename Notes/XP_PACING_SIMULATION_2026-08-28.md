...
`q = 0,80` passa a ser a regra central: `80 + 45 × (nível − 1) + arredondar(0,80 × (nível − 1)²)`. A recalibração com os onze planetas atuais — incluindo as rotas de 28 minutos do Arquivo Abissal, 32 minutos de Verdântia, 36 minutos de Caldeira, 40 minutos do Condomínio Lunar e 44 minutos da Necrópole Solar — coloca o perfil de 160 combustível e rota mais barata no nível 247 ao fim do ano. O jogador gratuito padrão termina no 127. Os desbloqueios iniciais continuam vivos: níveis 4/8/13/19/30 chegam aproximadamente nos dias 1/2/4/8/19; nível 50 no dia 51 e nível 100 no dia 223 para o perfil gratuito padrão.
