...
| `STYLE_LOCK_BATCH_PT.md` | Rascunho externo em revisão para um primeiro candidato Pistoleiro Orbital; não substitui o lote canónico de 17 ficheiros enquanto a divergência não for decidida. |
