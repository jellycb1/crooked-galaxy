...
O sistema atual prova 36 vitórias e 36 identidades de inimigo de primeira conclusão, distribuídas por no mínimo 36 dias bem-sucedidos. A cronologia real, porém, é espaçada por níveis, chaves e derrotas: no baseline de 55% por tentativa, o perfil gratuito equilibrado conclui as duas realidades alcançáveis por volta dos dias 23 e 254 e não alcança nível 160; o perfil mais rápido com 160 combustível e três repetições conclui as três por volta dos dias 13, 82 e 224. Portanto a Fenda atual não preenche sozinha 365 dias para o perfil máximo. Eventos rotativos, Arena e coleção permanente continuam necessários, e uma futura realidade só deve entrar com nível/chave que cubra o intervalo medido, doze identidades, traduções, envelope de combate e contrato visual. O fallback existente permanece até arte fornecida pelo utilizador passar o gate; nenhum asset substituto será criado por Codex.
