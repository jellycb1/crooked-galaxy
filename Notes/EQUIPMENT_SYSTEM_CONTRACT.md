...
A Oficina segue exatamente o mesmo contrato universal: um seletor compacto coloca qualquer espaço equipado na bancada e apresenta uma única ficha de calibração/reforço de cada vez. Arma e armadura não possuem privilégios mecânicos; peças vazias ficam visíveis mas indisponíveis.
...
- Cada intervenção exige simultaneamente Sucata e um serviço em Créditos escalado pelo nível da peça e pelo trabalho anterior. A falta de qualquer saldo rejeita toda a transação sem cobrança parcial.
...
Estado atual: as etapas 1–4 estão implementadas e simuladas. A etapa 5 começou de forma controlada: o Arquivo Abissal N-9 introduz implantes no catálogo normal ao nível 40; os packs seguintes aprofundam ciclicamente espaços universais, chegando à Fábrica de Coincidências Industriais com luvas no nível 310 e à Central de Reinícios Cósmicos com capacetes no nível 320. Gadget e relíquia permanecem nos dois setores maduros da Fenda Clandestina, com três recompensas únicas e universais por espaço. O catálogo normal mantém 2 180 combinações família/variante; novas séries são identificadas antes da decisão e consultadas por planeta sem construir o catálogo inteiro no mesmo frame. A Oficina serve os nove espaços, cobra Sucata e Créditos e inclui todas as peças nas projeções de combate. Recompensas avançadas da Fenda guardam o nível económico autorado; schema 25 repara cópias antigas equipadas, armazenadas ou pendentes sem mudar identidade ou stats. Drops normais para gadget/relíquia continuam bloqueados até comparação e identidade visual suportarem esse volume.
