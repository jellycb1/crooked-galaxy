...
Estado atual: as etapas 1–3 estão implementadas e simuladas. O catálogo inicial contém 380 combinações família/variante; novas séries são identificadas antes da decisão e consultadas por planeta sem construir o catálogo inteiro no mesmo frame. Pacotes de atributos continuam deliberadamente bloqueados pela etapa 4.
