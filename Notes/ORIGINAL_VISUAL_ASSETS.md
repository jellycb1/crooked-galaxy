...
Generated on 2026-08-24 with the built-in OpenAI image-generation workflow. No reference image was supplied to the generator. All prompts required fully original compositions, omitted text/logos/characters, and reserved a subdued central region for the existing portrait mobile UI.
