...
Conteúdo atual: 46 incidentes, dois por cada um dos vinte e três planetas de gameplay. Cada incidente contém três opções/ícones de escolha no código.
...
| Retratos dos 92 alvos atuais | 92 |
| Habitats dos 23 planetas atuais | 23 |
| Camadas de arena dos 23 planetas | 23 |
| Medalhões dos 23 planetas atuais | 23 |
| Incidentes atuais | 46 |
| Transportes | 4 |
| NPCs de serviço | 5 |
...
1. vinte e três habitats e medalhões;
2. 92 alvos;
3. 46 incidentes;
4. vinte e três arenas;
5. VFX de combate;
...
2. packs visuais dos vinte e três planetas;
