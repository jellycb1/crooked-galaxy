...
| `assets/ui/panel_frame_space.png` | Moldura focal anterior | `LEGACY` | Manter temporariamente apenas para comparação de regressão; já não é carregada pelo runtime. |
