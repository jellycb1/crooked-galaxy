...
$StageMap = @{
    ...
    "workshop.png.bin" = Join-Path $ReferenceRoot "others\shopsprites\Shakes_Store_2K.png"
    "market.png.bin" = Join-Path $ReferenceRoot "dealer\default\dealer_day.png"
    "hangar.png.bin" = Join-Path $ReferenceRoot "stable\stable_Tag_good_2k.png"
