...
static func loot_slots_for_planet(planet_id: String) -> Array[String]:
	match planet_id:
		...
		"resort_horizonte_eventos":
			return ["weapon", "weapon", "weapon", "armor", "armor", "helmet", "helmet"]
		"tribunal_clones_nao_autorizados":
			return ["weapon", "weapon", "weapon", "armor", "armor", "rig", "rig"]
		"mosteiro_gravidade_reversa":
			return ["weapon", "weapon", "weapon", "armor", "armor", "implant", "implant"]
		"mercado_memorias_usadas":
			return ["weapon", "weapon", "weapon", "armor", "armor", "boots", "boots"]
		"estaleiro_naufragios_temporais":
			return ["weapon", "weapon", "weapon", "armor", "armor", "gloves", "gloves"]
		"bolsa_luas_fracionadas":
			return ["weapon", "weapon", "weapon", "armor", "armor", "helmet", "helmet"]
		"fabrica_sois_recondicionados":
			return ["weapon", "weapon", "weapon", "armor", "armor", "rig", "rig"]
		"clinica_planetas_descontinuados":
			return ["weapon", "weapon", "weapon", "armor", "armor", "implant", "implant"]
		"correio_buracos_minhoca":
			return ["weapon", "weapon", "weapon", "armor", "armor", "boots", "boots"]
		"aquario_oceanos_confiscados":
			return ["weapon", "weapon", "weapon", "armor", "armor", "gloves", "gloves"]
		"central_sonhos_penhorados":
			return ["weapon", "weapon", "weapon", "armor", "armor", "helmet", "helmet"]
		"canil_asteroides_domesticos":
			return ["weapon", "weapon", "weapon", "armor", "armor", "rig", "rig"]
		"cartorio_ultimo_horizonte":
			return ["weapon", "weapon", "weapon", "armor", "armor", "implant", "implant"]
		"universidade_vilania_correspondencia":
			return ["weapon", "weapon", "weapon", "armor", "armor", "boots", "boots"]
		"agencia_deuses_reformados":
			return ["weapon", "weapon", "weapon", "armor", "armor", "gloves", "gloves"]
		"reserva_especies_impossiveis":
			return ["weapon", "weapon", "weapon", "armor", "armor", "helmet", "helmet"]
		"oficina_realidades_defeituosas":
			return ["weapon", "weapon", "weapon", "armor", "armor", "rig", "rig"]
		"seguradora_apocalipses_evitaveis":
			return ["weapon", "weapon", "weapon", "armor", "armor", "implant", "implant"]
		"leilao_imperios_falidos":
			return ["weapon", "weapon", "weapon", "armor", "armor", "boots", "boots"]
		"fabrica_coincidencias_industriais":
			return ["weapon", "weapon", "weapon", "armor", "armor", "gloves", "gloves"]
		"central_reinicios_cosmicos":
			return ["weapon", "weapon", "weapon", "armor", "armor", "helmet", "helmet"]
		_:
