...
Each of those six destinations now carries an original scalable emblem: crossed tools for the arsenal, a price tag for the market, a shuttle for the hangar, orbital rings for the map, a medal for career, and a visor portrait for the hunter. The icon-first grammar follows the reference's glanceable navigation principle without copying its imagery or adding bitmap residency.
