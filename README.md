...
Hunter level 8 reveals the Fenda Clandestina, a twelve-floor one-time PvE ladder independent of ordinary warrants. It enters the existing animated automatic combat directly, shows deterministic build odds and the exact unique reward before entry, and advances only after the current floor's reward is claimed. Six visible class-neutral anomaly profiles form introductory and mature variants of opening, rupture, and anchor pressure. Their exact rule and intended build axis appear in the dossier before entry; none branches on a class ID or scales enemies from the player. Floors one through three introduce technical rigs, four through six implants, seven through nine gadgets, and ten through twelve alien relics. All four families remain universal, lateral rewards with authored effects rather than raw vertical shortcuts. The compact 2×2 progress track keeps all sectors legible on a 450×800 Android screen. Fenda wins grant fixed credits and XP but never increase warrant rank, planet captures, target mastery, or capture streak; defeats preserve both floor progress and the player's active warrant streak. The Career ledger includes its own locked/current/completed Fenda track and direct route into the next floor, so parallel progression remains visible outside the Frontier Menu.
