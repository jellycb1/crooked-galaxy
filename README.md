...
It currently includes two complete four-target chapters: Dustball Prime and the frozen corporate world Congelária S.A., each culminating in an original boss and reusable planet-completion screen. Finishing Dustball unlocks a persistent galaxy map and travel. Each planet tracks captures and unlocks harder local warrants independently. A workshop turns unused loot into scrap and spends it on deterministic equipment upgrades. The slice also includes per-target capture records, three risk/reward approaches per contract, mid-hunt incidents with economic and combat consequences, AFK-safe hunt resolution, a guided first contract, scalable procedural character portraits, runtime-synthesized sound effects, layered automatic combat with named actions and speed control, a capture beat, procedural equipment with original flavor text, an arsenal screen, XP and level progression, simulation-backed risk estimates, post-reward feedback, and local persistence.
