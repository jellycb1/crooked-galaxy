...
Their in-motion panel keeps the remaining wall-clock time live and states explicitly that ignoring the incident applies no consequence. Detours add 30, 45, or 60 seconds instead of the obsolete one-to-three-second prototype values.
