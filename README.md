...
All eight current worlds now live in validated per-world packs under
...
Long-career navigation keeps progress legible: galaxy cards distinguish completed chapters and name each open planet's current warrant, while career shortcuts jump directly between planetary progress and the thirty-two-target archive.
...
The archive keeps all thirty-two records but orders the active planet's four warrants first, making late-career contract access immediate without erasing chronological history.
...
The career summary now exposes next-level XP as a real progress bar. Its eight paginated destination rows retain colored capture bars and explicit completed/current/locked states, keeping the complete sector overview usable before milestones while the thirty-two-record archive remains one shortcut away. Verdântia deliberately uses the generic fallback until its user-authored planet deliveries arrive.
