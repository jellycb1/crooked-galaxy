...
Long-career navigation keeps progress legible: galaxy cards distinguish completed chapters and name each open planet's current warrant, while career shortcuts jump directly between planetary progress and the twenty-eight-target archive.
...
The archive keeps all twenty-eight records but orders the active planet's four warrants first, making late-career contract access immediate without erasing chronological history.
...
The career summary now exposes next-level XP as a real progress bar. Its seven destination rows reuse the galaxy's original planet motifs, colored capture bars, and explicit completed/current/locked states, keeping the complete sector overview visible before milestones while the twenty-eight-record archive remains one shortcut away.
